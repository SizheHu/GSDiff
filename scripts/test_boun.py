...
sys.path.append('/home/user00/HSZ/gsdiff_boun-main/scripts/metrics')
sys.path.append('/root/autodl-tmp/gsdiff_boun-main')
sys.path.append('/root/autodl-tmp/gsdiff_boun-main/datasets')
sys.path.append('/root/autodl-tmp/gsdiff_boun-main/gsdiff_boun')
...
from gsdiff_boun.heterhouse_81_106_3 import BoundHeterHouseModel
from datasets.rplang_edge_semantics_simplified_81 import RPlanGEdgeSemanSimplified_81
from gsdiff_boun.heterhouse_56_32 import BoundEdgeModel
